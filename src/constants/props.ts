...
export const theme = {
  type: String as PropType<'primary' | 'secondary' | 'success' | 'info' | 'warning' | 'danger' | 'light' | 'dark'>,
  validator(this: never, val: string) {
    return ['primary', 'secondary', 'success', 'info', 'warning', 'danger', 'light', 'dark'].includes(val)
  },
}//主题颜色
